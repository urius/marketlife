...
public struct ShopObjectModelFactory
{
    ...
    {
        var config = GameConfigManager.Instance.MainConfig.GetShelfConfigById(levelId);
    ...
    {
        var config = GameConfigManager.Instance.MainConfig.GetCashDeskConfigById(levelId);
