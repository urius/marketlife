...
public class UILeaderboardsPopupMediator : IMediator
{
    ...
    private readonly Dictionary<TabType, float> _contentPositionsByTab = new Dictionary<TabType, float>();
    ...
    {
        _contentPositionsByTab[_currentTab] = _lastContentPosition;
    ...
    private TabType GetTabByTabIndex(int tabIndex)
    {
