...
public class UIContentPopupPlusView : UIContentPopupView
{
    ...
    [SerializeField] private TMP_Text _midButtonText;
    [SerializeField] private Button _rightButton;
    [SerializeField] private TMP_Text _rightButtonText;

    public void SetupButtonsAmount(bool haveCloseButton = true, int bottomButtonsAmount = 0)
    {
